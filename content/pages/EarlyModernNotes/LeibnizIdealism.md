...
Conditions (1)-(5) must be satisfied by anything that is to count as a substance
...
[^9]: One thing represents or expresses another “when there is a constant and
    fixed relation between what can be said of one and what can be said of
    another” (letter to Arnauld, G 2:112/L 339; see also NE 2.8.13, A/RB 131).
    In other words, representation involves an isomorphism between *res
    repraesentans* and *res repraesentata*. Resemblance is the paradigm case,
    but other forms of isomorphism seem also to be counted by Leibniz as forms
    of expression. For example, planar projective drawings represent solids,
    maps represent cities, musical notation represents a musical work, and
    so on. (@simmons2001, 41-2)
